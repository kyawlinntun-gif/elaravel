                    ...
                    <div class="product-details"><!--product-details-->
                        ...
                        <div class="col-sm-7">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <p><b>Brand:</b> {{ $product->manufacture->name }}</p>
    ...
    <script>
        $(function(){
            $('#addCart').on('click', function(){
                var qty = $(this).parent().children('input[type="text"]').val();
                var product_id = $(this).parent().children('input[type="hidden"]').val();
                var token = "{{ Session::token() }}";

                $.ajax({
                    method: 'POST',
                    url: '{{ url("cart/add") }}',
                    data: {_token: token, qty: qty, product_id: product_id},
